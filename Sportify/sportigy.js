...
// const circlePause=`<svg xmlns="http://www.w3.org/2000/svg" class="play-btn-library" viewBox="0 0 24 24" width="40" height="40" fill="none">
//     <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.5" />
//     <rect x="7" y="7" width="4" height="10" fill="currentColor" rx="1" />
//     <rect x="13" y="7" width="4" height="10" fill="currentColor" rx="1" />
// </svg>`
// const circlePlay=`<svg xmlns="http://www.w3.org/2000/svg" class="play-btn-library" viewBox="0 0 24 24" width="40" height="40" fill="none">
//                         <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.5" />
...
async function getSongs(folder){
    ...
    for (let i = 0; i < as.length; i++) {
        ...
        if(element.href.endsWith(".mp3")){
            ...
            let svg =`http://192.168.1.8:3000/${folder}/images/${fileName.replace("mp3","jpg")}`
            
            const imgUML =await checkImageExists(svg);
            if(!imgUML){
